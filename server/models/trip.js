...
// const createTrip = async (trip) => {
//     const { user_id, name, start_date, end_date, photo } = trip;
  
//     const insertQuery = `
//       INSERT INTO trips (user_id, name, start_date, end_date, photo_url)
//       VALUES ($1, $2, $3, $4, $5)
//       RETURNING *;
//     `;
...
//     const insertValues = [user_id, name, start_date, end_date, photo];
...
// const updateTripById = async (tripId, tripUpdates) => {
//   const { name, start_date, end_date, photo_url } = tripUpdates;
//   const query =
//     "UPDATE trips SET name = $2, start_date = $3, end_date = $4, photo_url = $5 WHERE id = $1 RETURNING *";
//   const values = [tripId, name, start_date, end_date, photo_url];
//   const { rows } = await db.query(query, values);
//   return rows[0];
// };
